...
public class CalculadoraGrafica extends JFrame implements ActionListener {
 ...
 public void Botones() //Creamos los botones a utilizar en la ventana
 {
 ...
 public void actionPerformed(ActionEvent e) 
 {
     ...
     String resultado;
        if (e.getSource()==btnsuma) { //Validaciones del boton suma
        ...
        if (e.getSource()==btnresta) { //Validaciones del boton restar
          if(valor1.getText().equals("") || valor2.getText().equals(""))
          {
            JOptionPane.showMessageDialog(null, "ERROR: Los datos no están completos",
        ...
        if (e.getSource()==btnmulti) { //Validaciones del boton multiplicar
          if(valor1.getText().equals("") || valor2.getText().equals(""))
          {
            JOptionPane.showMessageDialog(null, "ERROR: Los datos no están completos",
            "Error",JOptionPane.ERROR_MESSAGE); 
        ...
        if (e.getSource()==btndiv) { //Validaciones del boton dividir
          if(valor1.getText().equals("") || valor2.getText().equals(""))
          {
            JOptionPane.showMessageDialog(null, "ERROR: Los datos no están completos",
            "Error",JOptionPane.ERROR_MESSAGE);
